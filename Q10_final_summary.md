...
- **Product availability:** At-risk customers' top past products were confirmed still in stock and still being purchased by other customers. ✗ Not the cause.
...
- **Geography:** Revenue declined broadly across nearly all countries (65–85%, including the UK at -75.30%), indicating a company-wide pattern rather than a regional issue.
...
Our best customers (Champions, Loyal, and Top 20 by revenue) drive a disproportionate share of company revenue and should be actively protected. A clearly defined at-risk group — worth 1.58% of revenue, with an additional 820K+ in fully silent customer revenue — shows early signs of churn that our data confirms is **not** rooted in product or pricing issues. This points toward external, relationship-driven causes, meaning next quarter's priority should be proactive retention outreach and competitive monitoring rather than catalog or pricing changes.
